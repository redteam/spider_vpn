...
A: public class StartOpenVPNActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	final String EXTRA_NAME = "com.ecomdev.openvpn.shortcutProfileName";

        Intent shortcutIntent = new Intent(Intent.ACTION_MAIN);
		shortcutIntent.setClassName("com.ecomdev.openvpn", "com.ecomdev.openvpn.LaunchVPN");
...
am start -a android.intent.action.MAIN -n com.ecomdev.openvpn/.LaunchVPN -e com.ecomdev.openvpn.shortcutProfileName Home

Q: How to control the app from an external app?

A: There is an AIDL interface. See src/com/ecomdev/openvpn/api/IOpenVPNAPIService.aidl. See the normal Android documentation how to use AIDL.
