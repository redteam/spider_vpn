package com.ecomdev.vpndialogxposed;
               ...
               // IConnectivityManager mService = IConnectivityManager.Stub.asInterface(
                ...
                try {
                    ...
                    */
                    ...
                    HashSet<String> developmentApp = new HashSet<String>();
                    developmentApp.add("com.ecomdev.openvpn");
                  //  developmentApp.add("com.ecomdev.nothingset");

                    pref.reload();
                    Set<String> allowedApps = pref.getStringSet("allowedApps",developmentApp);
